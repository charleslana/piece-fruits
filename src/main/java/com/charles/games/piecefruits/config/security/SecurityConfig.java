...
import com.charles.games.piecefruits.config.security.filter.CustomAuthenticationFilter;
import com.charles.games.piecefruits.config.security.filter.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(new CustomAuthorizationFilter(ms, propertiesConfig, service), UsernamePasswordAuthenticationFilter.class);
        return http.build();
    }
